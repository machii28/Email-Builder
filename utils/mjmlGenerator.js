export function convertHtmlToMjml(htmlContent) {
  const htmlToMjmlMap = {
    ...
    '<p([^>]*)>': '<mj-text$1>',
    '</p>': '</mj-text>',
    '<h1([^>]*)>': '<mj-text font-size="24px" font-weight="bold"$1>',
    '</h1>': '</mj-text>',
    '<h2([^>]*)>': '<mj-text font-size="20px" font-weight="bold"$1>',
    '</h2>': '</mj-text>',
    '<h3([^>]*)>': '<mj-text font-size="18px" font-weight="bold"$1>',
    '</h3>': '</mj-text>',
    '<h4([^>]*)>': '<mj-text font-size="16px" font-weight="bold"$1>',
    '</h4>': '</mj-text>',
    '<h5([^>]*)>': '<mj-text font-size="14px" font-weight="bold"$1>',
    '</h5>': '</mj-text>',
    '<h6([^>]*)>': '<mj-text font-size="12px" font-weight="bold"$1>',
    '</h6>': '</mj-text>',
    '<img([^>]*)>': '<mj-image$1 />',
    '<a([^>]*)>': '<mj-button$1>',
    '</a>': '</mj-button>',
